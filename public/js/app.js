  ...
  return _c("div", { staticClass: "dropdown relative" }, [
    _c(
      "div",
      {
        ...
        attrs: { "area-haspopup": "true", "area-expanded": _vm.isOpen },
        on: {
    ...
    _c(
      "div",
      {
        ...
        staticClass: "dropdown-menu absolute bg-card py-2rounded shadow mt-2",
...
var BirdboardForm = /*#__PURE__*/function () {
  function BirdboardForm(data) {
    ...
    this.originalData = {}; // This is SHALLOW MERGE
    // Object.assign(this.originalData, data);

    this.originalData = JSON.parse(JSON.stringify(data)); // This is DEEP MERGE
...
__webpack_require__(/*! /Users/happy/code/birdboard/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/happy/code/birdboard/resources/sass/app.scss */"./resources/sass/app.scss");
